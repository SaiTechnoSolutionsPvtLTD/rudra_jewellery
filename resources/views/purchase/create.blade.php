    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4 pb-4">
        <div>
            <div class="text-xs text-gray-500 font-medium flex items-center gap-2 mb-2">
                <a href="#" class="hover:text-gray-900">Purchase</a>
                <span class="text-gray-400">/</span>
                <span class="text-gray-900 font-semibold">Add Purchase</span>
            </div>
            <h1 class="text-xl font-bold text-gray-900">Add Purchase</h1>
            <p class="text-sm text-gray-500 mt-1">Add new metal purchase and update stock</p>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col h-full lg:col-span-3">
                <h2 class="text-sm font-bold text-gray-900 mb-6">Purchase Details</h2>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5 mb-6">
                    ...
                    <div>
                        ...
                        <div class="relative w-full">
                            <input type="text" value="100" class="block w-full pl-4 pr-10 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:border-[#b01622] focus:ring-1 focus:ring-[#b01622] font-medium placeholder-gray-400">
                    ...
                    <div>
                        ...
                        <input type="text" value="7,23,800" disabled class="block w-full px-4 py-2.5 border border-gray-100 rounded-lg text-sm text-gray-500 bg-gray-50 font-medium cursor-not-allowed">
                    </div>

                    <!-- Supplier -->
                    <div>
                        <label class="block text-xs font-semibold text-gray-900 mb-2">Supplier (Optional)</label>
                        <div class="relative w-full">
                    ...
                    <!-- Purchase Date -->
                    <div>
                        <label class="block text-xs font-semibold text-gray-900 mb-2">Purchase Date <span class="text-red-500">*</span></label>
                        <div class="relative w-full">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="border border-gray-200 rounded-xl p-5 bg-white shadow-sm">
                        <div class="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-center text-center">
                            ...
                            <div></div>
                            <div class="text-[10px] text-gray-500 font-medium">Purchase</div>
                            <div></div>
                            <div class="text-[10px] text-gray-500 font-medium">New Stock</div>
                            
                            <div class="text-[13px] font-bold text-gray-900 mt-2">50 GM</div>
                            <div class="text-gray-400 font-bold mt-2 mx-1">+</div>
                            <div class="text-[13px] font-bold text-gray-900 mt-2">+ 100 GM</div>
                            <div class="text-gray-400 font-bold mt-2 mx-1">=</div>
                    ...
                    <div class="border border-gray-200 rounded-xl p-5 bg-white shadow-sm">
                        <div class="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-center text-center">
                            <div class="text-[13px] font-bold text-gray-900 mb-2">50 GM</div>
                            <div class="text-gray-400 font-bold mb-2 mx-1">+</div>
                            <div class="text-[13px] font-bold text-gray-900 mb-2">100 GM</div>
                            <div class="text-gray-400 font-bold mb-2 mx-1">=</div>
                            <div class="text-[13px] font-bold text-green-500 mb-2">150 GM</div>
                ...
                <table class="w-full text-center">
                    <thead class="bg-gray-50/50 border-b border-gray-100 text-[11px] text-gray-500 font-semibold">
                        <tr>
                            ...
                            <th class="py-3 px-4 font-semibold">Purchase (GM)</th>
                    ...
                    <tbody class="text-[11px] font-semibold text-gray-900">
                        <tr class="border-b border-gray-50">
                            ...
                            <td class="py-4 px-4 text-gray-500">50 GM</td>
                            <td class="py-4 px-4 text-green-500">+ 100 GM</td>
                            <td class="py-4 px-4 text-green-500">150 GM</td>
                            <td class="py-4 px-4">
